...
urlpatterns = [
    ...
    url(r'^createSnapshot/$', views.create_snapshot_topo, name='createSnapshot'),
    url(r'^rebuildInstance/$', views.rebuild_instance, name='rebuildInstance'),
    url(r'^rebuildServer/$', views.rebuild_server, name='rebuildServer'),
